   ...
   <div class="sidebar-page-container">
    ...
    ?>
                ...
                <?php 
                        ...
                        INNER JOIN tbl_subscriber ON (tbl_constructor.constructor_id = tbl_subscriber.constructor_id) WHERE tbl_subscriber.status = 'Verified' AND tbl_project.status = 'Published' ";
                        ...
                        INNER JOIN tbl_constructor ON (tbl_project.constructor_id = tbl_constructor.constructor_id)
                        INNER JOIN tbl_subscriber ON (tbl_constructor.constructor_id = tbl_subscriber.constructor_id) WHERE tbl_subscriber.status = 'Verified' AND tbl_project.status = 'Published' LIMIT $page_1, $per_page";
                    ...
                    <div class="styled-pagination">
                        ...
                        <?php 
                            ...
                            if($i == $page) {
                                ...
                                echo "<li '><a href='project.php?page={$i}'>{$i}</a></li>";
                            }
